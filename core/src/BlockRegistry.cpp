...
bool insertBlockFactory(BlockRegistry& registry, const BlockRegistration& registration) { return registry.insert(registration.name, registration.alias, registration.factory, registration.attributes, registration.labels); }
} // namespace gr
